...
# Paths
SRC_DIR = Path(r"C:\Users\mannu\Downloads\archive (1)\NEU-DET")
DST_DIR = Path(r"d:\Industrial-defect-system\data")
...
if __name__ == "__main__":
    if not SRC_DIR.exists():
        print(f"Source directory {SRC_DIR} does not exist. Check path.")
    else:
        create_yaml()
        process_split("train")
